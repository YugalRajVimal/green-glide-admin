...
export default function SignInForm() {
  ...
  const [email, setEmail] = useState<string>(""); // Initialize with empty string for better type inference
  const [isOTPFieldsVisible, setIsOTPFormVisible] = useState(false);
  const [otp, setOTP] = useState<string>(""); // Initialize with empty string
  ...
  // Helper function to clear the alert state
  const clearAlert = () => {
    setAlert({
      isEnable: false,
      variant: "info",
  ...
  const handleGetOTP = async () => {
    clearAlert(); // Clear any previous alerts when a new action is initiated
      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div>
          <div className="mb-4">
            {alert.isEnable && (
              <Alert
                variant={alert.variant as any} // Type assertion for variant prop
                title={alert.title}
            ...
            <div>
              <div className="space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      clearAlert(); // Clear alert when user starts typing in email field
                    }}
                  />
                </div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        clearAlert(); // Clear alert when user starts typing in OTP field
                      }}
                    />
                  </div>
                </div>
                ...
                <div>
                  {isOTPFieldsVisible ? (
                    <>
                      {/* The previous <p> tag for "OTP sent to your email!" was removed
                          as the Alert component now handles this message for consistency. */}
                      <Button
                        onClick={handleLogIn}
                        className="w-full"
                        size="sm"
