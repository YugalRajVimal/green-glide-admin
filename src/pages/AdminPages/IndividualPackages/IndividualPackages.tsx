...
export default function IndividualPackages() {
  const [packages, setPackages] = useState([
    ...
    },
    {
      ...
      daysCount: 7,
      amount: 200,
      features: ["Access to core features", "Community support", ""], // ensure 3 fields
      editable: false,
    },
    {
  ...
  return (
    <div>
      <PageMeta title="Individual Packages" description="Edit subscription packages" />
            ...
            <ComponentCard title={pkg.name}>
              ...
              <div className="mb-3">
                ...
                <Input
                  ...
                  disabled={!pkg.editable}
                  onChange={(e) => handleChange(index, "periodType", e.target.value)}
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <Input
                  ...
                  value={pkg.daysCount}
                  disabled={!pkg.editable}
                  onChange={(e) => handleChange(index, "daysCount", parseInt(e.target.value, 10))}
                />
              </div>
