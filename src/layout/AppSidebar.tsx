...
const navItems: NavItem[] = [
  ...
  // },
  {
    ...
    icon: <ListIcon />,
    subItems: [
      { name: "Individuals", path: "/individual-users", pro: false },
      { name: "Organisations", path: "/organisation-users", pro: false },
    ],
  },
  {
    name: "Packages",
    icon: <ListIcon />,
    subItems: [
      { name: "Individual Packages", path: "/individual-packages", pro: false },
      {
        name: "Organisation Packages",
